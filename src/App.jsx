            ...
            <>
              ...
              <div style={{ marginBottom: '3.5rem' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1.5rem' }}>
                  <div style={{ background: 'linear-gradient(135deg, rgba(56, 189, 248, 0.05) 0%, rgba(15, 23, 42, 0.4) 100%)', border: '1px solid rgba(56, 189, 248, 0.1)', padding: '1.5rem', borderRadius: '20px', display: 'flex', alignItems: 'flex-start', gap: '1rem', transition: 'transform 0.3s', ':hover': { transform: 'translateY(-5px)' } }}>
                    <div style={{ fontSize: '2rem', background: 'rgba(56, 189, 248, 0.15)', padding: '12px', borderRadius: '14px', color: '#38bdf8' }}>📝</div>
                    <div>
                      <h4 style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', marginBottom: '4px' }}>Weekly Mock Tests</h4>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', lineHeight: '1.5', margin: 0 }}>Regular assessments to track speed, accuracy, and overall growth before real exams.</p>
                    </div>
                  </div>

                  <div style={{ background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.05) 0%, rgba(15, 23, 42, 0.4) 100%)', border: '1px solid rgba(16, 185, 129, 0.1)', padding: '1.5rem', borderRadius: '20px', display: 'flex', alignItems: 'flex-start', gap: '1rem', transition: 'transform 0.3s', ':hover': { transform: 'translateY(-5px)' } }}>
                    <div style={{ fontSize: '2rem', background: 'rgba(16, 185, 129, 0.15)', padding: '12px', borderRadius: '14px', color: '#10b981' }}>💡</div>
                    <div>
                      <h4 style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', marginBottom: '4px' }}>Live Doubt Classes</h4>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', lineHeight: '1.5', margin: 0 }}>Smart board learning with dedicated 1-on-1 doubt clearing sessions for every student.</p>
                    </div>
                  </div>

                  <div style={{ background: 'linear-gradient(135deg, rgba(245, 158, 11, 0.05) 0%, rgba(15, 23, 42, 0.4) 100%)', border: '1px solid rgba(245, 158, 11, 0.1)', padding: '1.5rem', borderRadius: '20px', display: 'flex', alignItems: 'flex-start', gap: '1rem', transition: 'transform 0.3s', ':hover': { transform: 'translateY(-5px)' } }}>
                    <div style={{ fontSize: '2rem', background: 'rgba(245, 158, 11, 0.15)', padding: '12px', borderRadius: '14px', color: '#f59e0b' }}>🎁</div>
                    <div>
                      <h4 style={{ color: 'white', fontSize: '1.1rem', fontWeight: '800', marginBottom: '4px' }}>Top Performer Rewards</h4>
                      <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', lineHeight: '1.5', margin: 0 }}>Exciting gifts and motivation drives to reward discipline and consistent performance.</p>
                    </div>
                  </div>
                </div>
              </div>
